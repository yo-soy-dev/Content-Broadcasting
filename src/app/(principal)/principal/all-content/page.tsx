                  ...
                  <tr key={item._id}
                    ...
                    <td className="px-4 py-3">
                      ...
                      {item.rejectionReason && (
                        <p className="text-xs text-red-400 mt-0.5">Reason: {item.rejectionReason}</p>
                      )}
                    </td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3">
                      <span className={`px-2 py-1 rounded-full text-xs font-medium border ${statusStyles[item.status]}`}>
