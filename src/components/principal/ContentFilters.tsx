      ...
      <div className="flex flex-col md:flex-row gap-3 items-start md:items-center justify-between">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-8 py-2.5 rounded-xl border
            ...
            return (
              <button
                ...
                className={`inline-flex items-center gap-1.5 px-3.5 py-1.5
                  text-xs font-semibold rounded-full transition
                  ${isActive
        ...
        <div className="flex items-center gap-2 mt-3 pt-3 border-t
          ...
          {activeStatus !== "all" && (
            <span className="inline-flex items-center gap-1 px-2.5 py-0.5
              ...
              <button
                ...
                className="hover:text-red-800 dark:hover:text-red-200 transition ml-0.5"
              >
                <X size={10} />
              </button>
            </span>
          ...
          {search && (
            <span className="inline-flex items-center gap-1 px-2.5 py-0.5
              ...
              <button
                onClick={() => setSearch("")}
                className="hover:text-gray-800 dark:hover:text-gray-100 transition ml-0.5"
              >
                <X size={10} />
              </button>
            </span>
