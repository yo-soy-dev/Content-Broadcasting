    ...
    <div className="min-h-screen flex items-center justify-center bg-[#071a12] px-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8 gap-3">
          ...
          <div
            className="w-14 h-14 rounded-2xl bg-green-500/90 flex items-center
        ...
        {/* Glass card */}
        <div
          className="rounded-2xl bg-green-900/30 border border-green-500/20
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2
                    text-green-300/50 hover:text-green-200 transition-colors"
                  aria-label={
            ...
            {error && (
              <div
                className="px-3.5 py-2.5 rounded-xl bg-red-500/10
          ...
          {/* ── Demo credentials ── */}
          <div className="mt-6 pt-5 border-t border-green-500/20">

            <p
              className="text-[10px] font-semibold uppercase tracking-widest
              text-green-400/50 mb-3"
            >
              Demo Credentials
            </p>
              ...
              {DEMO_CREDENTIALS.map((cred) => (
                <button
                  ...
                  className="w-full flex items-center justify-between px-4 py-3
                    rounded-xl border border-green-500/20 bg-green-950/40
                ...
                >
                  ...
                  <div>
                    ...
                    <p
                      className="text-[11px] text-green-300/50
                      font-mono mt-0.5"
                    >
                      {cred.email}
                    </p>
                  ...
                  <span
                    className="text-xs text-green-400 opacity-0
